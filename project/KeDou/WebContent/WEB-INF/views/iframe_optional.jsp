...
<body>
	<div id="est_cn">
	 ...
	 <form class="bs-example bs-example-form" role="form" action="${ctx }/course/searchFirstCourseList" method="get" id="search" target="_top" onsubmit="return  onSubmitSearch() ">
            <div class="row">
               <div class="col-lg-10">
