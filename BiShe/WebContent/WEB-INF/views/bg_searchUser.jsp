	...
	<form action="${ctx}/collection/batchdelete?page=${page }" method="post">
		<table cellspacing="4" cellpadding="0" class="table">
				<tr>
					...
					<th class="tr-th1" style="vertical-align:middle;">用户ID</th>
					<th class="tr-th1" style="vertical-align:middle;">用户名</th>
					<th class="tr-th1" style="vertical-align:middle;">预测成绩</th>
					<th class="tr-th1" style="vertical-align:middle;">学校</th>
					<th class="tr-th1" style="vertical-align:middle;">考试年份</th>
					<th class="tr-th1" style="vertical-align:middle;">专业</th>
					<th class="tr-th1" style="vertical-align:middle;">删除</th>
				</tr>
				<c:forEach items="${studentList }" var="p">
				<tr class="test" id="">
					<th class="tr-td1" style="display:table-cell; vertical-align:middle"><input type="checkbox" name="tempString"  style="margin-right: 10px;margin-left: 18px;checked:false" value="${p.stuId }"></th>
					<td class="tr-td" style="display:table-cell; vertical-align:middle">${p.stuId }</td>
					<td class="tr-td"  style="display:table-cell; vertical-align:middle">${p.stuName }</td>
					<td class="tr-td" style="display:table-cell; vertical-align:middle">${p.stuGrade }</td>
					<td class="tr-td" style="display:table-cell; vertical-align:middle">${p.school }</td>
					<td class="tr-td" style="display:table-cell; vertical-align:middle">${p.examYear }</td>
					<td class="tr-td" style="display:table-cell; vertical-align:middle">${p.profession }</td>
					<th class="tr-td1" style="display:table-cell; vertical-align:middle"><a href="${ctx}/bg_admin/deleteUser?id=${p.stuId}"><div class="delete"><i class="icon icon-trash icon-1x"></i></div></a></th>
				</tr>
				</c:forEach>
		</table>
	</form>
