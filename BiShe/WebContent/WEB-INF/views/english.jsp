	...
	<div style="background-color: #F9F8F7; width: 100%; height: 100%;">
		<div class="container" style="background-color: white;">
					...
					<div id="content-left-top">
						<div id="content-nav">
							<ul class="nav nav-tabs">
								<li><a href="${ctx }/chapter/progress?stuId=1">数学</a></li>
								<li><a href="#">英语</a></li>
						...
						<div id="course-list">
							<c:forEach items="${el }" var="el">
								<form role="form" action="${ctx }/chapter/englishchapter"
									method="post" class="registration-form">
									<div class="course">
										<div class="course-img">
											<p class="hl-danger">${el.type }</p>
										</div>
										<div class="course-info">

											<div class="input-group" id="estart">
												<input type="text" style="display: none" name="stuId"
													id="stuId" value="${ stuId}"> <input type="text"
													style="display: none" name="typeId" id="typeId"
													value="${el.id }"> <span class="input-group-addon">开始时间</span>
												<input type="text" class="form-control" name="startDate"
													id="startDate" placeholder="00:00"> <span
													class="input-group-addon fix-border">结束时间</span> <input
													type="text" class="form-control" name="finishDate"
													id="finishDate" placeholder="00:00">

											</div>

											<div class="input-group" id="estart2">
			...
			<div id="content-right-top">
				<div class="adcardss">
					<form role="form" action="${ctx }/exam/english" method="post"
						...
						<div class="input-group" style="margin-left: 4%;">
							<span class="input-group-addon">日期</span> <input type="text"
								class="controlss" name="date" id="date"
