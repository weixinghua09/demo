	...
	<body>
		<div class="container-fluid" id="person_banner">
			<div id="header">
				...
				<!--搜索框-->
				<div id="find">
					<form action="${ctx }/student/searchForum" id="searchForm" method="get">
						<div class="input-group">
							<div class="input-control search-box search-box-circle has-icon-left has-icon-right search-example" id="searchboxExample">
								...
								<input id="stuId" name="stuId" type="hidden" value="${stu.stuId }" />
		...
		<div class="main_left">
				...
				<div class="username_mananger">账户管理</div>
					...
					<a  href="${ctx }/student/allMyForum?stuId=${stu.stuId}" target="preson_megs">
