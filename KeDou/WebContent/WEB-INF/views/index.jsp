...
<body>
      <div id="myCarousel" class="carousel slide">
         ...
         <!-- 轮播（Carousel）项目 -->
         <div class="carousel-inner" id="imgRun">
            <div class="item active">
            <img src="${ctx }/img/index1.jpg" alt="First slide">
            </div>
            <div class="item">
            <img src="${ctx }/img/index2.jpg" alt="Second slide">
            </div>
            <div class="item">
            <img src="${ctx }/img/index3.jpg" alt="Third slide">
            </div>
         </div>
         <!-- 轮播（Carousel）导航 -->
   ...
   <script>
      $(document).ready(function(){ 
         ...
         $('#imgRun').css("width",window.innerWidth+'px');
         $('#imgRun').css("height",window.innerHeight+'px');
