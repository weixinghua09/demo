    ...
    <div class="main-inner body-width">
      <div class="banner clearfix">
        ...
        <div class="banner-info">
          <div class="news body-border">
            ...
            <c:forEach items="${hotspotlist }" var="b">
              <li class="link" >
                <a href="#">${b.name }</a>
                <span></span>
              </li>
      ...
      <div class="main-cont main-album">
        ...
        <c:forEach items="${Articlelist}" var="c">
          <li class="item">
            <a href="${ctx }/forum/details?keyid=${c.id }" class="pic"><img src="${articleImgPath}/${c.titleimg}" alt="#"></a>
            <div class="info">
              <a href="${ctx }/forum/details?keyid=${c.id }" class="title">${c.title }</a>
              <p>${c.likes }个赞 · ${c.collections }人收藏</p>
              <p>by <a href="#" class="author">${c.author}</a></p>
            </div>
          </li>
        </c:forEach>
        </ul>
		...
		<c:forEach items="${relist}" var="m">
          <li class="item item-cur">
            ...
            <div class="waterfall-hover">
              ...
              <a href="javascript:void(0);" onclick="collect(this);" id="${m.id }" class="btn-collect">收藏 </a>
              <a href="#" class="btn-white btn-like"></a>
              <a href="#" class="btn-white btn-comment"></a>
            </div>
            <div class="waterfall-info">
              <p class="title">${m.title}</p>
              <p class="icon"><span class="icon-star"> ${m.collections}</span><span class="icon-like"> ${m.likes}</span></p>
            </div>
            <div class="collect-info">
             <!--   <a href="details.html" class="headImg"><img src="images/cont/waterfall_headImg1.jpeg" alt="#"></a>-->
              <p class="title"><a href="#"> ${m.author}</a></p>
              <p class="to">收藏到<a href="#">时尚语型录</a></p>
            </div>
          </li>
         </c:forEach>           
        </ul>
